        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {upcomingBatches.map((batch) => (
            <motion.div
              ...
              className="glass-panel p-6 rounded-3xl border border-slate-800 hover:border-cyan-500/40 transition-all duration-300 flex flex-col justify-between shadow-xl"
            >
              <div>
                ...
                <div className="flex items-center justify-between gap-2 mb-4">
                  ...
                  <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-rose-500/10 border border-rose-500/30 text-rose-400 text-xs font-mono-tech font-bold">
              ...
              <div className="pt-4 border-t border-slate-800/80">
                ...
                <div className="w-full h-2 bg-slate-900 rounded-full overflow-hidden mb-5">
                  <div 
                ...
                <button
                  ...
                  className="w-full py-3 rounded-xl font-bold text-xs text-slate-950 bg-gradient-to-r from-cyan-400 via-sky-300 to-indigo-300 hover:from-cyan-300 hover:to-indigo-200 shadow-lg shadow-cyan-500/20 hover:scale-[1.02] transition-all flex items-center justify-center gap-2"
                >
